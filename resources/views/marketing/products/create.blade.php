...
<form action="{{ route('marketing.products.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1 space-y-6">
        <div class="card-modern p-6">
            ...
            <div class="mb-4" id="containerMaxPrice" style="{{ old('price_type') == 'range' ? '' : 'display: none;' }}">
        ...
        <div class="card-modern p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="border border-gray-200 rounded-lg p-5 bg-gray-50 flex flex-col">
                    ...
                    <div id="rentalPriceContainer" style="{{ old('is_rentable') ? '' : 'display: none;' }}" class="mt-auto pt-3 border-t border-gray-200">
                ...
                <div class="border border-gray-200 rounded-lg p-5 bg-gray-50 flex flex-col">
                    ...
                    <div id="flexibleComponentsContainer" style="{{ old('has_flexible_components') ? '' : 'display: none;' }}" class="mt-auto pt-3 border-t border-gray-200">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Base select template (clone from first row is easier but we can just use template literal)
