...
<body class="bg-florist-50 text-gray-800 antialiased min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl border border-florist-100 overflow-hidden">
        <div class="p-8 text-center bg-gradient-to-br from-florist-100 to-white">
            <div class="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-florist-100">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" id="username" class="pl-10 w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-florist-400 focus:border-florist-400 outline-none transition-all" placeholder="Misal: admin, florist1" required value="{{ old('username') }}">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" class="pl-10 w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-florist-400 focus:border-florist-400 outline-none transition-all" placeholder="••••••••" required>
                    </div>
                </div>
                
                <button type="submit" class="w-full py-3 px-4 bg-florist-500 hover:bg-florist-600 text-white font-semibold rounded-lg shadow-md shadow-florist-200 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-florist-500">
                    Masuk ke Sistem
                </button>
            </form>
