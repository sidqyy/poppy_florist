                    ...
                    <div id="delivery_fields" class="hidden space-y-4 border-t border-gray-100 pt-4 mt-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="delivery_fee" id="delivery_fee" value="{{ old('delivery_fee') }}" min="0" class="w-full px-4 py-2 border border-gray-300 bg-white rounded-lg text-gray-600 outline-none font-bold">
                            </div>
                        </div>
