            ...
            <div class="bg-white p-6 rounded-2xl shadow-md border-2 border-gray-200">
                ...
                <div class="space-y-4">
                    <div class="relative" id="product_autocomplete_wrapper">
                        ...
                        <input type="text" name="product_name" id="product_name" autocomplete="off" required value="{{ old('product_name', $order->product_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-florist-400 outline-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            @endphp
                            <input type="number" name="total_price" id="total_price" required min="0" value="{{ old('total_price', $basePrice) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-florist-400 outline-none font-bold">
                        </div>
